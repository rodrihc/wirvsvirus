...
public class DocDbDao implements TweetDao {
    ...
    private DocumentCollection getTodoCollection() {
        ...
        final List<DocumentCollection> collectionList = documentClient
                .queryCollections(getTodoDatabase().getSelfLink(),
        ...
        try {
            ...
            collectionCache = documentClient.createCollection(getTodoDatabase().getSelfLink(),
    ...
    private Document getDocumentText(String text) {
        ...
        List<Document> documentList = documentClient
                .queryDocuments(getTodoCollection().getSelfLink(),
                        "SELECT * FROM root r WHERE r.text LIKE '%" + text + "%'", null)
    ...
    @Override
    public Tweet readTweet(String id) {

        // Retrieve the document by id using our helper method.
        Document tweet = getDocumentText(id);

        if (tweet != null) {
            // De-serialize the document in to a TodoItem.
            return gson.fromJson(tweet.toString(), Tweet.class);
    ...
    public List<Tweet> readTweet() {
        ...
        for (Document todoItemDocument : documentList) {
            tweets.add(gson.fromJson(todoItemDocument.toString(),
                    Tweet.class));
        }
