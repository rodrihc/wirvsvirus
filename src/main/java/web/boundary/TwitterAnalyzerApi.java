...
public class TwitterAnalyzerApi {
    ...
    public Response getCheck(@QueryParam("lang") @DefaultValue("de") final String lang, final String bodyRequest) {
        ...
        try {
            ...
            final Map<String, Integer> weights = twitterAnalyzerController.pollTerms(20, terms);
    ...
    public Response putHashtags(@QueryParam("lang") @DefaultValue("de") final String lang,
        ...
        try {
            ...
            twitterAnalyzerController.doConnection(terms);
            final Map<String, Integer> tweets = twitterAnalyzerController.putHashtags(count, terms, lang);
